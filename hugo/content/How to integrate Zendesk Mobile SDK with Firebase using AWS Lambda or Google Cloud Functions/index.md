---
title: 'Integrating Zendesk Mobile SDK with Firebase using AWS Lambda'
date: '2017-12-04'
image: 'How-to-integrate-Zendesk-Mobile-SDK-with-Firebase-using-AWS-Lambda-or-Google-Cloud-Functions'
tags:
  - firebase
  - ios
  - nodejs
...
{{< my-picture name="Serverless-backend-for-Zendesk-Mobile-SDK-Enabling-SDK" >}}

Then we need to go to settings to Mobile SDK configuration and click “Add App” button

{{< my-picture name="Serverless-backend-for-Zendesk-Mobile-SDK-Settings" >}}
